...
ALTER TABLE AGENT ADD CONSTRAINT AGENT_PK PRIMARY KEY ( "ID Agenta" ) ;
...
ALTER TABLE SPOTKANIA ADD CONSTRAINT SPOTKANIA_AGENT_FK FOREIGN KEY ( "ID Agenta" ) REFERENCES AGENT ( "ID Agenta" ) ;
...
ALTER TABLE UMOWY ADD CONSTRAINT UMOWY_AGENT_FK FOREIGN KEY ( "ID Agenta" ) REFERENCES AGENT ( "ID Agenta" ) ;
